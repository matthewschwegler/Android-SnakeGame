...
public class Settings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout classicScoreLayout = (RelativeLayout) findViewById(R.id.settings_layout);
    ...
    private void initSwipeButton() {
        ...
        compileAnimation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                isSwipeOn = preferences.getBoolean(GameSettings.USE_BUTTON_CONTROLS, true);
                if (isSwipeOn) {
                ...
                swipeButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        SharedPreferences preferences1 = getApplicationContext()
                                .getSharedPreferences(GameSettings.PREFS_NAME, Context.MODE_PRIVATE);
                        SharedPreferences.Editor editor = preferences1.edit();
                        editor.putBoolean(GameSettings.USE_BUTTON_CONTROLS, isSwipeOn);
                        editor.commit();
                    }
                });
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                homeButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Animation animationSwipe = AnimationUtils.loadAnimation(Settings.this, R.anim.reverse_for_classic_button);
